...
`BACKUP_ARCHIVE_ENCRYPTION_PASSWORD` | `` | If `BACKUP_ARCHIVE` is set to `true` and a password is provided, the tarball will be encrypted. If no password is given, encryption is disabled. 
